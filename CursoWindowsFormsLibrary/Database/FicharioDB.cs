...
namespace CursoWindowsFormsLibrary.Database
{
    public class FicharioDB
    {
        ...
        public LocalDBClass LocalDBClass { get; set; }

        public FicharioDB(string table)
        {
            Status = true;
            try
            {
                LocalDBClass = new LocalDBClass();
                this.Table = table;
        ...
        public string Buscar(string id)
        {
            ...
            try
            {
                ...
                DataTable dt = LocalDBClass.SQLQuery(sql);
                if (dt.Rows.Count > 0)
                {
